-- Expand sessions.agent_kind CHECK for Swival CLI.
--
-- Keep the complete V47 schema, indexes, and scope-pairing triggers while
-- adding the `swival` wire value.
...
CREATE TABLE sessions_new (
    ...
    agent_kind               TEXT NOT NULL CHECK (agent_kind IN ('claude-code','codex','open-code','cursor','gemini-cli','claude-desktop','openclaw','antigravity-cli','omp','pi','crush','grok','zero','devin','kimi-code','kiro-cli','command-code','swival','hermes','other')),
    cwd                      TEXT,
